...
import { stripProxyEnv } from "../src/lib/net-diagnostics.js";
import {
  DATA_DIR,
  HOST,
  LOG_DIR,
...
const POLL_INTERVAL_MS =
  Number.parseInt(process.env.TRAECODE_ENHANCER_WATCHDOG_INTERVAL_MS ?? "", 10) || 15_000;
...
async function startDaemon() {
  ...
  const child = spawn(launch.command, launch.args, {
    ...
    env: {
      ...
      TRAECODE_ENHANCER_UI_PORT: String(UI_PORT),
    },
  });
  child.unref();
