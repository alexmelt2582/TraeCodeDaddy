...
const cdpPort = parsePort(process.env.TRAECODE_ENHANCER_CDP_PORT, DEFAULT_CDP_PORT);
const uiPort = parsePort(process.env.TRAECODE_ENHANCER_UI_PORT, DEFAULT_UI_PORT);
