...
export const UI_PORT = parsePort(process.env.TRAECODE_ENHANCER_UI_PORT, DEFAULT_UI_PORT);
export const DATA_DIR = process.env.TRAECODE_ENHANCER_DATA_DIR || DEFAULT_DATA_DIR;
